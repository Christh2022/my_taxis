...
const Setting = ({ hide }) => {
    ...
    return (
        <div className={`setting_content ${hide && "setting_isActive"}`}>
                ...
                <div className="box_setting_info">
                    ...
                    <div className="second_box_setting">
                        ...
                        <div className="body_second_box_setting">
                                ...
                                <div className="container_bsetting">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <span>roldichristh@gmail.com</span>
                                        </li>
                                        <li>
                                            <div>
                                                <span>
                            ...
                            {setting == "activity" && (
                                <div className="container_bsetting">
                                    <h5>Aucune Activité pour le moment</h5>
                                </div>
                            )}
                        </div>
                    </div>
